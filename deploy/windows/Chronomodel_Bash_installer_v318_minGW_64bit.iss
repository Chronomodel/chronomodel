...
#define MyAppName "ChronoModel_Bash"
...
Source: "..\..\..\build-Chronomodel_bash-Desktop_Qt_6_2_4_MinGW_64_bit-Release\build\release\chronomodel_bash.exe"; DestDir: "{app}"; Flags: ignoreversion
