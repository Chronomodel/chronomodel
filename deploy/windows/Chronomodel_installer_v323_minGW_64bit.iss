...
Source: "..\..\..\build-Chronomodel-Desktop_Qt_6_4_3_MinGW_64_bit-Release\build\release\chronomodel.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "additionnal_files\Qt_6_4_3\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
