...
Source: "..\..\..\build-Chronomodel_bash-Desktop_Qt_6_4_3_MinGW_64_bit-Release\build\release\chronomodel_bash.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "additionnal_files\Qt_6_4_3\*"; DestDir: "{app}"; Flags: onlyifdoesntexist recursesubdirs createallsubdirs
