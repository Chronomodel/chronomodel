...
robocopy /s C:\Users\Lanos\Documents\github\chronomodel\deploy\windows\additionnal_files\Qt_6_6_3 C:\Users\Lanos\Documents\github\chronomodel\QtInstaller_ChronoModel\installer-packages-winOS\chronomodel_QtIFW.composant1\data
...
C:\Qt\Tools\QtInstallerFramework\4.6\bin\binarycreator --offline-only -c installer-config/config.xml -p installer-packages-winOS ChronoModel_v%VERSION%_Qt6.6.3_win64_%date:~6,4%%date:~3,2%%date:~0,2%_Installer
