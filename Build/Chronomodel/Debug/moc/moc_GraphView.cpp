...
#include "../../../../../../../../Desktop/Chronomodel/Projects/Chronomodel/src/Views/GraphView.h"
...
void *GraphView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "GraphViewAbstract"))
        return static_cast< GraphViewAbstract*>(const_cast< GraphView*>(this));
