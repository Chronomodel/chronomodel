    ...
    case 1:
        {
            ...
            if (singleGraph) {
                ...
                mStatsBut->move(0, mMargin);
                mExportImgBut->move(mStatsBut->x() + mStatsBut->width(), mMargin);
                mExportResults->move(mExportImgBut->x() + mExportImgBut->width(), mMargin);

                mToolsWidget->resize(mOptionsW, mStatsBut->height() + 2*mMargin);
                //mToolsWidget->update();
            }
